...
class Welcome(Scene):
    ...
    def draw(self):
        self.text_screen("Welcome to MyGame",self.GREEN,self.WIDTH/2,self.HEIGTH/2-20,True)
        self.text_screen("enter space to start",self.GREEN,self.WIDTH/2,self.HEIGTH/2+20,True)
