...
class Welcome(Scene):
    ...
    def draw(self):
        self.text_screen("Welcome to Dino",self.BLACK,self.WIDTH/2,self.HEIGTH/2-20,True)
        self.text_screen("enter to start",self.BLACK,self.WIDTH/2,self.HEIGTH/2+20,True)
